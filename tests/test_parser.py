...
HTW_DETECT_CHANGED_1 = BluetoothServiceInfo(
    name="",
    manufacturer_data={28932: b'\x03\xe0G', 11271: b'\xfe\x00\x01', 39940: b'\xb4\rA', 5380: b'\xaeD>', 11012: b'\x8d\xc0>', 9476: b'\x95\x1b=', 54788: b"\xab'=", 2820: b'\n\xea=', 14084: b'\xa6\xb2=', 54532: b'\x8f\x18=', 40708: b'\x0f_=', 56324: b'\x8e\x17=', 49156: b'_\xfd<', 43012: b'9\xe8<', 11268: b'+\xe0<', 22020: b'\x8d\x16=', 50692: b'j\x03=', 31748: b'l\x04=', 63492: b'\x83\x11=', 3332: b'\xc76=', 37636: b'\x8e\x17=', 42756: b'x\x0b=', 9732: b'\xad(=', 1284: b'\x99\x1d=', 10756: b'v\n=', 12548: b'k\x04=', 21764: b'U\xf8<', 43780: b'=\xeb<', 3588: b'C\xee<', 42500: b'2\xe5<', 3844: b'$\xdd<'}, service_uuids=['ef090000-11d6-42ba-93b8-9dd7ec090ab0'],rssi=-53,
...
HTW_DETECT_CHANGED_2 = BluetoothServiceInfo(
    name="",
    manufacturer_data={28932: b'\x03\xe0G', 11271: b'\xfe\x00\x01', 39940: b'\xb4\rA', 5380: b'\xaeD>', 11012: b'\x8d\xc0>', 9476: b'\x95\x1b=', 54788: b"\xab'=", 2820: b'\n\xea=', 14084: b'\xa6\xb2=', 54532: b'\x8f\x18=', 40708: b'\x0f_=', 56324: b'\x8e\x17=', 49156: b'_\xfd<', 43012: b'9\xe8<', 11268: b'+\xe0<', 22020: b'\x8d\x16=', 50692: b'j\x03=', 31748: b'l\x04=', 63492: b'\x83\x11=', 3332: b'\xc76=', 37636: b'\x8e\x17=', 42756: b'x\x0b=', 9732: b'\xad(=', 1284: b'\x99\x1d=', 10756: b'v\n=', 12548: b'k\x04=', 21764: b'U\xf8<', 43780: b'=\xeb<', 3588: b'C\xee<', 42500: b'2\xe5<', 3844: b'$\xdd<', 14596: b'6\xe7<'}, service_uuids=['ef090000-11d6-42ba-93b8-9dd7ec090ab0'], rssi=-52,
    address="aa:bb:cc:dd:ee:ff",
    service_data={},
    source="local",
)
...
def test_ht_w_large_data_set():
    ...
    assert result == SensorUpdate(title=None,
             devices={None: SensorDeviceInfo(name=None,
                                             model='HT.w',
                                             manufacturer='SensorPush',
                                             sw_version=None,
                                             hw_version=None)},
             entity_descriptions={DeviceKey(key='signal_strength', device_id=None): SensorDescription(device_key=DeviceKey(key='signal_strength',
                                                                                                                           device_id=None),
                                                                                                      device_class=SensorDeviceClass.SIGNAL_STRENGTH,
                                                                                                      native_unit_of_measurement=Units.SIGNAL_STRENGTH_DECIBELS_MILLIWATT)},
             entity_values={DeviceKey(key='signal_strength', device_id=None): SensorValue(device_key=DeviceKey(key='signal_strength',
                                                                                                               device_id=None),
                                                                                          name='Signal '
                                                                                               'Strength',
                                                                                          native_value=-53)},
    ...
    assert result2 == SensorUpdate(title=None,
             devices={None: SensorDeviceInfo(name='',
                                             model='HT.w',
                                             manufacturer='SensorPush',
                                             sw_version=None,
                                             hw_version=None)},
             entity_descriptions={DeviceKey(key='temperature', device_id=None): SensorDescription(device_key=DeviceKey(key='temperature',
                                                                                                                       device_id=None),
                                                                                                  device_class=SensorDeviceClass.TEMPERATURE,
                                                                                                  native_unit_of_measurement=Units.TEMP_CELSIUS),
                                  DeviceKey(key='humidity', device_id=None): SensorDescription(device_key=DeviceKey(key='humidity',
                                                                                                                    device_id=None),
                                  ...
                                  DeviceKey(key='signal_strength', device_id=None): SensorDescription(device_key=DeviceKey(key='signal_strength',
                                                                                                      ...
                                                                                                      device_class=SensorDeviceClass.SIGNAL_STRENGTH,
                                                                                                      native_unit_of_measurement=Units.SIGNAL_STRENGTH_DECIBELS_MILLIWATT)},
             entity_values={DeviceKey(key='temperature', device_id=None): SensorValue(device_key=DeviceKey(key='temperature',
                                                                                                           device_id=None),
                                                                                      name='Temperature',
                                                                                      native_value=20.44),
                            DeviceKey(key='humidity', device_id=None): SensorValue(device_key=DeviceKey(key='humidity',
                                                                                                        device_id=None),
                                                                                   name='Humidity',
                                                                                   native_value=38.7),
...
def test_htp_w_large_data_set():
    ...
    assert result2 == SensorUpdate(title=None,
             ...
             entity_descriptions={DeviceKey(key='signal_strength', device_id=None): SensorDescription(device_key=DeviceKey(key='signal_strength',
                                                                                                      ...
                                                                                                      device_class=SensorDeviceClass.SIGNAL_STRENGTH,
                                                                                                      native_unit_of_measurement=Units.SIGNAL_STRENGTH_DECIBELS_MILLIWATT),
                                  DeviceKey(key='temperature', device_id=None): SensorDescription(device_key=DeviceKey(key='temperature',
                                                                                                                       device_id=None),
                                                                                                  device_class=SensorDeviceClass.TEMPERATURE,
                                                                                                  native_unit_of_measurement=Units.TEMP_CELSIUS),
                                  DeviceKey(key='humidity', device_id=None): SensorDescription(device_key=DeviceKey(key='humidity',
                                                                                               ...
                                                                                               device_class=SensorDeviceClass.HUMIDITY,
                                                                                               native_unit_of_measurement=Units.PERCENTAGE),
                                  DeviceKey(key='pressure', device_id=None): SensorDescription(device_key=DeviceKey(key='pressure',
                                                                                                                    device_id=None),
             ...
             entity_values={DeviceKey(key='signal_strength', device_id=None): SensorValue(device_key=DeviceKey(key='signal_strength',
                                                                                          ...
                                                                                          name='Signal '
                                                                                               'Strength',
                                                                                          native_value=-60),
                            DeviceKey(key='temperature', device_id=None): SensorValue(device_key=DeviceKey(key='temperature',
                                                                                                           device_id=None),
                                                                                      name='Temperature',
                                                                                      native_value=22.3),
                            DeviceKey(key='humidity', device_id=None): SensorValue(device_key=DeviceKey(key='humidity',
                                                                                   ...
                                                                                   name='Humidity',
                                                                                   native_value=52.81),
                            DeviceKey(key='pressure', device_id=None): SensorValue(device_key=DeviceKey(key='pressure',
                                                                                                        device_id=None),
                                                                                   name='Pressure',
                                                                                   native_value=997.59)},
             binary_entity_descriptions={},
